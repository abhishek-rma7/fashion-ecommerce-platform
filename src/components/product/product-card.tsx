  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {product.salePrice && (
          <span className="absolute top-2 md:top-2.5 3xl:top-7 start-2 md:start-2.5 3xl:start-7 bg-heading text-white text-10px md:text-sm leading-5 rounded-md inline-block px-2 xl:px-3 pb-1">
            {product.discount}%
          </span>
        )}
      </div>
