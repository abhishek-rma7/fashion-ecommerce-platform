...
const ProductOverlayCard: React.FC<ProductProps> = ({
  ...
  return (
    <div
      ...
      className={`${classes} cursor-pointer group flex flex-col bg-gray-50 rounded-md relative items-center justify-between overflow-hidden`}
    >
      <div
        className="flex justify-center items-center p-2 h-full 3xl:min-h-[330px]"
        title={product?.name}
      >
        <Image
          src={
