    ...
    <nav className={classNames(`headerMenu flex w-full relative`, className)}>
      {data?.map((item: any) => (
        ...
        >
          <Link
            href={item.path}
            className="inline-flex items-center text-sm xl:text-base text-heading px-3 xl:px-4 py-2 font-medium font-poppins relative group-hover:text-black uppercase tracking-wider"
          >
            {item.label}
